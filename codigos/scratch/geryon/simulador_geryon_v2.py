...
# Cambio de directorio a 10Myr_around0.1 para separar este experimento
ruta_guardado = os.path.join("runs_geryon", "10Myr_around0.1", job_name)

print("==================================================")
print(f"Iniciando configuración de disco estructurado v2:")
