# -*- coding: utf-8 -*-
"""
lanzador_gifs_10myr.py — Genera GIFs animados para todos los runs de data/runs/10Myr
====================================================================================

Para cada subdirectorio en data/runs/10Myr/ que tenga HDF5:
  - Crea data/runs/10Myr/<run>/gif/
  - Llama a disk_visualizer/disk_viz.py con los parámetros configurados
  - Guarda el GIF como data/runs/10Myr/<run>/gif/disco.gif

Uso
---
    py lanzador_gifs_10myr.py
    py lanzador_gifs_10myr.py --every 3 --fps 8 --rmax 25
    py lanzador_gifs_10myr.py --skip-existing

Argumentos (todos opcionales)
------------------------------
  --datadir     Carpeta raíz de datos      (default: data/runs/10Myr)
  --every       1 de cada N snapshots      (default: 2)
  --fps         Frames por segundo del GIF (default: 15)
...
def main():
    parser = argparse.ArgumentParser(
        description="Genera GIFs para todos los runs de data/runs/10Myr."
    )
    parser.add_argument("--datadir",      default="data/runs/10Myr",
                        help="Carpeta raíz de datos (default: data/runs/10Myr)")
    parser.add_argument("--every",        type=int,   default=2,
                        help="1 de cada N snapshots (default: 2)")
    parser.add_argument("--fps",          type=int,   default=15,
                        help="FPS del GIF (default: 15)")
